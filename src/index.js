...
import { localeToLang, detectScript, langToScript, isSameLanguage } from './lang.js';
...
const HELP_TEXTS = {
    en: {
        ...
        mylang: ['/mylang',
            'Check your current translation language setting.'],
        tips: ['Tips',
    ...
    ko: {
        ...
        mylang: ['/mylang', '현재 번역 언어 설정을 확인합니다.'],
    ...
    es: {
        ...
        mylang: ['/mylang', 'Consulta tu idioma de traducción actual.'],
    ...
    fr: {
        ...
        mylang: ['/mylang', 'Vérifiez votre langue de traduction actuelle.'],
    ...
    de: {
        ...
        mylang: ['/mylang', 'Überprüfe deine aktuelle Übersetzungssprache.'],
    ...
    pt: {
        ...
        mylang: ['/mylang', 'Verifique seu idioma de tradução atual.'],
    ...
    ru: {
        ...
        mylang: ['/mylang', 'Проверьте текущий язык перевода.'],
    ...
    it: {
        ...
        mylang: ['/mylang', 'Controlla la tua lingua di traduzione attuale.'],
    ...
    vi: {
        ...
        mylang: ['/mylang', 'Kiểm tra ngôn ngữ dịch hiện tại của bạn.'],
    ...
    th: {
        ...
        mylang: ['/mylang', 'ตรวจสอบภาษาแปลปัจจุบันของคุณ'],
    ...
    ar: {
        ...
        mylang: ['/mylang', 'تحقق من لغة الترجمة الحالية.'],
    ...
    hi: {
        ...
        mylang: ['/mylang', 'अपनी वर्तमान अनुवाद भाषा जाँचें।'],
    ...
    id: {
        ...
        mylang: ['/mylang', 'Periksa bahasa terjemahan Anda saat ini.'],
    ...
    tr: {
        ...
        mylang: ['/mylang', 'Mevcut çeviri dilinizi kontrol edin.'],
...
${t.tips[1]}`;
    ...
    // --- /mylang command ---
    if (interaction.isChatInputCommand() && interaction.commandName === 'mylang') {
        const prefs = store.get('userLanguagePrefs') || {};
